...
const Recommendations: React.FC = () => {
  ...
  if (showQuiz) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50">
        {/* Header */}
        <div className="bg-gradient-to-r from-purple-800 to-indigo-600 text-white py-12">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-purple-800 to-indigo-600 text-white py-8">
        <div className="container mx-auto px-4">
            ...
            <div key={recommendation.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="relative h-40">
                ...
                <button
                  ...
                  className="absolute top-3 right-3 p-2 bg-white rounded-full shadow-md hover:bg-purple-50 transition-colors"
                >
                  <Heart 
                    className={`w-5 h-5 ${
                ...
                <div className="absolute top-3 left-3">
                  <span className="px-2 py-1 bg-purple-700 text-white text-xs rounded-full">
              ...
              <div className="p-3">
                ...
                <div className="mb-3">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {(i18n.language === 'zh' ? recommendation.highlights : recommendation.highlightsEn)
                      ...
                      <span key={index} className="px-2 py-0.5 bg-purple-100 text-purple-700 text-[11px] rounded">
                        {highlight}
                      </span>
                    ))}
                  </div>
                ...
                {/* Action Button */}
                <button className="w-full bg-gradient-to-r from-purple-800 to-indigo-600 text-white py-2 px-3 rounded-lg hover:from-purple-900 hover:to-indigo-700 transition-colors text-sm">
