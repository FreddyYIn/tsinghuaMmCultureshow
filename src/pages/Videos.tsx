          ...
          {filteredVideos.map((video) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <button
                  onClick={() => setSelectedVideo(video)}
                  className="w-full mt-3 px-3 py-2 bg-gradient-to-r from-purple-600 to-indigo-500 text-white rounded-lg hover:from-purple-700 hover:to-indigo-600 transition-all duration-200 font-medium flex items-center justify-center space-x-2 text-sm"
                >
                  <Play size={18} />
