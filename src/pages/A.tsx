        ...
        if (city) {
          ...
          const iconHtml = `
            <div style="
              ...
              border: ${isSelected ? '4px solid #c4b5fd' : '3px solid white'}; 
              border-radius: 50%; 
              display: flex; 
              align-items: center; 
              ...
              font-weight: bold; 
              color: white;
              box-shadow: ${isSelected ? '0 0 0 4px rgba(109, 40, 217, 0.3), 0 4px 12px rgba(0,0,0,0.4);' : '0 2px 8px rgba(0,0,0,0.3)'};
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50">
        {/* 顶部标题 */}
        <div className="bg-gradient-to-r from-purple-800 via-indigo-700 to-blue-600">
