    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50">
      ...
      <section className="relative py-12 px-4 sm:px-6 lg:px-8">
        <div className="absolute inset-0 mx-4 rounded-3xl z-0 pointer-events-none">
          <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-purple-100/20 to-indigo-100/20" />
        </div>
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 text-center md:text-left">
            <img
              src="/images/logo.png"
              alt="平台 Logo"
              className="w-20 h-20 md:w-28 md:h-28 rounded-full opacity-80 pointer-events-none select-none flex-shrink-0 object-contain"
            />
            <div>

              <h1 className="text-3xl md:text-5xl font-bold bg-gradient-to-r from-purple-700 to-indigo-600 bg-clip-text text-transparent mb-4">
                {t('home.title')}
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6">
                <Link
                  to="/recommendations"
                  className="inline-flex items-center px-6 py-3 border border-transparent text-sm font-medium rounded-xl text-white bg-gradient-to-r from-purple-600 to-indigo-500 hover:from-purple-700 hover:to-indigo-600 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                >
