...
const Map: React.FC = () => {
  ...
  const categories = [
    { id: 'all', label: t('mapPage.categories.all'), icon: Star, color: 'bg-purple-600' },
    { id: 'cultural', label: t('mapPage.categories.cultural'), icon: Camera, color: 'bg-purple-700' },
    { id: 'natural', label: t('mapPage.categories.natural'), icon: TreePine, color: 'bg-indigo-500' },
    { id: 'adventure', label: t('mapPage.categories.adventure'), icon: Mountain, color: 'bg-indigo-600' },
    { id: 'spiritual', label: t('mapPage.categories.spiritual'), icon: Waves, color: 'bg-purple-500' }
  ];
  ...
  const getCategoryColor = (category: string) => {
    const categoryMap = {
      ...
      natural: 'bg-indigo-500',
      adventure: 'bg-indigo-600',
      spiritual: 'bg-purple-500'
    };
    return categoryMap[category as keyof typeof categoryMap] || 'bg-purple-600';
  };
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
              {/* Map Header */}
              <div className="bg-gradient-to-r from-purple-800 via-indigo-700 to-blue-600 px-6 py-4">
                <h3 className="text-white font-semibold text-lg">{t('mapPage.title')}</h3>
              </div>
              
              {/* Interactive Map Placeholder */}
              <div className="relative h-96 bg-gradient-to-br from-purple-100 to-indigo-100 p-8">
                {/* Myanmar Map Outline */}
                <div className="absolute inset-4 bg-gradient-to-br from-purple-200 to-indigo-200 rounded-lg opacity-50"></div>
            ...
            {selectedLocation ? (
              <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div className="p-6">
                  ...
                  <button className="w-full px-3 py-2 bg-gradient-to-r from-purple-700 to-indigo-600 text-white rounded-lg hover:from-purple-800 hover:to-indigo-700 transition-all duration-200 font-medium text-sm">
                    {t('common.learnMore')}
                  </button>
                </div>
              </div>
